...
{{
var G__5915 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5915;
continue;
}
} else
...
{var pred__5919 = cljs.core._EQ_;var expr__5920 = limit;if(cljs.core.truth_(pred__5919.call(null,1,expr__5920)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__5919.call(null,2,expr__5920)))
...
var G__5922 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5923 = (limit__$1 - 1);
var G__5924 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5922;
limit__$1 = G__5923;
parts = G__5924;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5926 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5926))
{var replacement_5927 = temp__4090__auto___5926;buffer.append([cljs.core.str(replacement_5927)].join(''));
} else
{buffer.append(ch);
}
{
